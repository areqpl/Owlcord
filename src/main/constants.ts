...
export const USER_AGENT = `Owlcord/${app.getVersion()} (https://github.com/areqpl/Owlcord)`;
...
const VersionString = `AppleWebKit/537.36 (KHTML, like Gecko) Chrome/${process.versions.chrome} Safari/537.36`;
